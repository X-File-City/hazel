...
// TODO: To enable theme toggle, uncomment the following and import useTheme from a theme context
...
export function Globe({ className, config = GLOBE_CONFIG }: { className?: string; config?: COBEOptions }) {
	// TODO: To enable theme toggle, use: const { theme } = useTheme(); const isDarkMode = theme === "dark";
