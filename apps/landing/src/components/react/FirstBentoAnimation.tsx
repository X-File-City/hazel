...
export function ReasoningBasic() {
	const reasoningText = `I found 3 related discussions in #engineering from last week. The team decided to use WebSockets for real-time updates. Here's the summary and links to the relevant threads.`
		...
		<div ref={ref} className="w-full h-full p-4 flex flex-col items-center justify-center gap-5">
			...
			>
				<div className="flex items-end justify-end gap-3">
					...
					>
						<p className="text-sm">
							What did the team decide about the real-time sync approach last week?
						</p>
					</motion.div>
